...
public class RangeSlider: UIControl {
    ...
    @IBInspectable public var maximumValue: Double = 100000.0 {
        willSet(newValue) {
    ...
    fileprivate let extraThumbWidth: CGFloat = 20
    
    fileprivate var thumbWidth: CGFloat {
        return CGFloat(bounds.height + extraThumbWidth)
    }
    ...
    func updateLayerFrames() {
        ...
        lowerThumbLayer.frame = CGRect(x: lowerThumbCenter - thumbWidth / 2.0, y: -extraThumbWidth / 2, width: thumbWidth, height: thumbWidth)
        lowerThumbLayer.setNeedsDisplay()
        
        let upperThumbCenter = CGFloat(positionForValue(upperValue))
        upperThumbLayer.frame = CGRect(x: upperThumbCenter - thumbWidth / 2.0, y: lowerThumbLayer.frame.origin.y, width: thumbWidth, height: thumbWidth)
        upperThumbLayer.setNeedsDisplay()
